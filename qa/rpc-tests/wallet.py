...
#   c) node1 mines 32 blocks, so now node 0 has 60001crca, node 1 has 4250crca, node2 has none.
#   d) node0 sends 601 crca to node2, in two transactions (301 crca, then 300 crca).
