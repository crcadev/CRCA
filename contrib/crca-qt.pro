...
RESOURCES += src/qt/crca.qrc src/qt/crca_locale.qrc

TRANSLATIONS += src/qt/locale/crca_bg.ts \
                src/qt/locale/crca_de.ts \
                src/qt/locale/crca_en.ts \
                src/qt/locale/crca_es.ts \
                src/qt/locale/crca_fi.ts \
                src/qt/locale/crca_fr.ts \
                src/qt/locale/crca_it.ts \
                src/qt/locale/crca_ja.ts \
                src/qt/locale/crca_pl.ts \
                src/qt/locale/crca_pt.ts \
                src/qt/locale/crca_ru.ts \
                src/qt/locale/crca_sk.ts \
                src/qt/locale/crca_sv.ts \
                src/qt/locale/crca_vi.ts \
                src/qt/locale/crca_zh_CN.ts \
                src/qt/locale/crca_zh_TW.ts
