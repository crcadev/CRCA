 ...
 * Crca system. There are three: the main network on which people trade goods
...
public:
   ...
   // int GetFundFee() const { return nFundFee; }
    ...
    // const std::vector<unsigned char>& CrcaDevKey() const { return vCrcaDevKey; }
    // const std::vector<unsigned char>& CrcaFundKey() const { return vCrcaFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vCrcaDevKey;
