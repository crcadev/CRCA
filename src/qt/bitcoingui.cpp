...
QFontDatabase::addApplicationFont(":/fonts/crca_font");

QString windowTitle = tr("CRCA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CRCA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CRCA: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CRCA Core"), this);
    aboutAction->setStatusTip(tr("Show information about CRCA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CRCA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CRCA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CRCA addresses"));
    ...
    openAction->setStatusTip(tr("Open a CRCA: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CRCA Core help message to get a list with possible CRCA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CRCA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CRCA network", "", count));
}
...
{
    QString strTitle = tr("CRCA Core"); // default title
