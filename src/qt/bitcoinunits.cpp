...
// Copyright (c) 2017-2018 The CRCA Core developers
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CRCA:
            return QString("CRCA");
        case mPRJ:
            return QString("Milli-CRCA (1 / 1" THIN_SP_UTF8 "000)");
        case uPRJ:
            return QString("Micro-CRCA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
