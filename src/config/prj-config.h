/* src/config/crca-config.h.  Generated from crca-config.h.in by configure.  */
/* src/config/crca-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Crca_CONFIG_H

#define Crca_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.crca.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Crca Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Crca Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "crca"
