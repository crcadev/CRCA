...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Crca features */
        {"crca", "masternode", &masternode, true, true, false},
        {"crca", "listmasternodes", &listmasternodes, true, true, false},
        {"crca", "getmasternodecount", &getmasternodecount, true, true, false},
        {"crca", "masternodeconnect", &masternodeconnect, true, true, false},
        {"crca", "masternodecurrent", &masternodecurrent, true, true, false},
        {"crca", "masternodedebug", &masternodedebug, true, true, false},
        {"crca", "startmasternode", &startmasternode, true, true, false},
        {"crca", "createmasternodekey", &createmasternodekey, true, true, false},
        {"crca", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"crca", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"crca", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"crca", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"crca", "getmasternodescores", &getmasternodescores, true, true, false},
        {"crca", "mnsync", &mnsync, true, true, false},
        {"crca", "spork", &spork, true, true, false},
        {"crca", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"crca", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use crcad, or the -server option to crca-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> crca-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12888/\n";
}
