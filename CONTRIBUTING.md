Contributing to Crca Core
============================

The Crca Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Crca Core project, and is not to be
confused with overall Crca Network Protocol consensus changes.

Whether a pull request is merged into Crca Core rests with the project merge
...
Patches that change Crca consensus rules are considerably more involved than
...
Where a patch set proposes to change the Crca consensus, it must have been
...
The project leader is the release manager for each Crca Core release.
