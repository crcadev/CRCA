...
* WebSocket: [https://github.com/Crca-Core/insight-api-crca#web-socket-api](https://github.com/Crca-Core/insight-api-crca#web-socket-api)
* API: [https://github.com/Crca-Core/insight-api-crca#swifttx-transactions](https://github.com/Crca-Core/insight-api-crca#swifttx-transactions)
...
By default, the Crca Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Crca Core daemon:
