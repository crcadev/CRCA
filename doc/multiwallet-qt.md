...
In order to support loading of multiple wallets in crca-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crca.cpp.
...
Changes to crca.cpp
----------------------
crca.cpp is the entry point into crca-qt, and as such, will require some minor modifications to provide hooks for
